...
# Run unit tests (6 cases — docs, Android, Flutter, platform detection)
npx tsx --test mcp-servers/code-analyzer-mcp/src/docs.test.ts \
                mcp-servers/code-analyzer-mcp/src/extractors.test.ts

# stdio smoke (handshake + tools/list)
node scripts/mcp-smoke.mjs mcp-servers/code-analyzer-mcp/dist/index.js \
  discover_docs,detect_platform,extract_signals,analyze_project
```
